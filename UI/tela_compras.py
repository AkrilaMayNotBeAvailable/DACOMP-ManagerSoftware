...
class TelaCompras(ctk.CTkFrame):
    def __init__(self, master):
        ...
        purchases.grid(row=0, column=0, padx=10, pady=10, sticky="nswe")
    ...
    def inicializar_tela_de_compras(self, frame):
        ...
        campos['compras'].grid(row=0, column=0, padx=10, pady=5, sticky="en")
        ...
        # TODO: Adicionar opção de data atual
        # TODO: Conversão de data para o formato brasileiro DD/MM/AAAA
        ...
        # TODO: Conversão de valores com vírgula para ponto
    ...
    def abrir_nova_compra(self):
        try:
            ...
            encomenda_data = self.campos['data_encomenda_entry']['entry'].get() or "2000-01-01"
            recebimento_data = self.campos['data_recebimento_entry']['entry'].get() or "2000-01-01"
            valor = float(self.campos['valor_nota_entry']['entry'].get() or "0.00")
